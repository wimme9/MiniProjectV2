...
class MenuScene extends Phaser.Scene {
  ...
  buildHowToPlay() {
    ...
    const lines = [
      ...
      'ESC        หยุดชั่วคราว',
      '',
      'ไปให้ถึงเป้าหมายก่อนเวลา 60 วินาทีจะหมด',
      'เก็บเหรียญเพื่อคะแนน หลบหนามและหลุมพราง',
      'คุณมีพลังชีวิต 3 หน่วย หากหมดจะจบเกมทันที!',
      'ผ่านธงจุดตรวจเพื่อบันทึกความคืบหน้า',
      ''
    ];
